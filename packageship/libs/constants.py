...
ERROR_CON = {
    ...
    "50006": {
              "ERROR_CONTENT": "",
              "HINT": "Please check check the database configuration and try again"},
    # FILELIST_TYPE_ERROR
    "50007": {
              "ERROR_CONTENT": "",
...
def response_web(code, msg=None):
    """
    Description: Return error information according to the received error code
    Args:
        code:error code
        msg:error message
    Returns:
    ...
    try:
        ...
        return {
            "CODE": code,
            "ERROR_CONTENT": _msg,
            'HINT': "No matching error code was found, please check the error type"
        }
    _msg["ERROR_CONTENT"] = msg
    return _msg
