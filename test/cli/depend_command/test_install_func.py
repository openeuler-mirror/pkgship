...
HINT           :Please check the parameter is valid and query again
    ...
    def test_wrong_level_0(self):
        ...
        """
        self.command_params = ["CUnit", "-level=0"]
        self.excepted_str = """
    ERROR_CONTENT  :Request parameter error
    HINT           :Please check the parameter is valid and query again
            """
...
HINT           :Use the correct package name and try again
    ...
    def test_true_level_0(self):
        ...
        self.excepted_str = self.read_file_content(
            "installdep_data/installdep_Judy.txt", is_json=False)
        self.assert_result()
    ...
    def test_true_level_1(self):
        ...
        self.excepted_str = self.read_file_content(
            "installdep_data/install_Judy_level_1.txt", is_json=False)
        self.assert_result()
    ...
    def test_true_level_one_db(self):
        ...
        self.excepted_str = self.read_file_content(
            "installdep_data/installdep_Judy_level_1_dbs.txt", is_json=False)
        self.assert_result()
    ...
    def test_true_level_db(self):
        ...
        self.excepted_str = self.read_file_content(
            "installdep_data/installdep_Judy_dbs.txt", is_json=False)
        self.assert_result()
