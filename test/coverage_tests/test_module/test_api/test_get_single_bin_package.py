...
class TestGetSinglePack(ReadTestBase):
    ...
    """
    BASE_URL = "packages/bin/Judy?database_name={}&pkg_name={}"
    REQUESTS_KWARGS = {
        "url": "",
        "method": "GET"
    }
    ...
    @mock.patch.object(BinaryPackage, "bin_package_info")
    def test_true_parameters(self, mock_bin_package_info):
        """
    ...
    @mock.patch("packageship.application.core.pkginfo.pkg.BinaryPackage.bin_package_info",
