...
class TestDependInfoSelfDepend(ReadTestBase):
    """
    TestSelfDepend
    """
    ...
    def test_empty_parameter(self):
        ...
        """
        resp = self.client.post("/dependInfo/selfDepend",
                                data='{}',
    ...
    def test_true_params_result(self):
        ...
        """
        correct_list = get_correct_json_by_filename("dependinfo_self_depend")
