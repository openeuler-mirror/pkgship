<template>
    <div class="package-info">
        <el-form :inline="true" class="form">
            <div class="form-inputs">
                <el-form-item label="Product Version">
                    ...
                    <el-select class="mobile-select" v-model="formData.tableName" @change="initData(1)"
                ...
                <el-form-item label="Search">
                    <el-tooltip class="tool-tips"
                        content="Name of the binary package to be queried.Currently,only exact match is supported"
                        placement="bottom" effect="light">
                        <img src="@/assets/images/question.svg" alt="">
                    </el-tooltip>
                    <el-input v-model="formData.queryPkgName" class="pc-search" placeholder="Search Name"
                        @keyup.enter.native="initData(1)">
                        <i slot="suffix" class="icon-search" @click="initData(1)"></i>
                    </el-input>
                    <el-input v-model="formData.queryPkgName" class="mobile-search" placeholder="Search Name">
                        <i slot="suffix" class="icon-search" @click="initData(1)"></i>
                    </el-input>
                </el-form-item>
            </div>
        ...
        <template>
            <el-table :data="tableData" v-loading.fullscreen="tableLoading" class="pc-pkg-table" stripe
                style="width: 100%">
                <el-table-column prop="pkg_name" label="Name" width="180">
                ...
                <el-table-column prop="release" label="Release" width="180">
                </el-table-column>
                ...
                <el-table-column prop="source_name" label="src-package">
                </el-table-column>
            </el-table>
        ...
        <el-pagination class="safety-bulletin-pagination" :current-page.sync="formData.pageNum"
            :page-size="formData.pageSize" layout="total, prev, pager, next, jumper" @current-change="initData"
            :total="total">
        </el-pagination>
        <el-pagination class="mobile-safety-bulletin-pagination" :current-page.sync="formData.pageNum"
            :page-size="formData.pageSize" layout="prev, pager, next" @current-change="initData" :total="total">
        </el-pagination>
    </div>
</template>
