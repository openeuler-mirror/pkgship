<template>
    <div class="package-detail" v-loading.fullscreen="loading">
        ...
        <div class="pkg-info">
            ...
            <ul class="pkg-line">
                <li class="detail-title">File List:</li>
                <li v-if="detailData.filelist">
                    <div class="file-item">
                        <p class="item-title">dir:</p>
                        <p v-for="(item, index) in detailData.filelist.dir" :key="index">{{ item }}</p>
                    </div>
                    <div class="file-item">
                        <p class="item-title">file:</p>
                        <p v-for="(item, index) in detailData.filelist.file" :key="index">{{ item }}</p>
                    </div>
                    <div class="file-item">
                        <p class="item-title">ghost:</p>
                        <p v-for="(item, index) in detailData.filelist.ghost" :key="index"> {{ item }} </p>
                    </div>
                </li>
            </ul>
        </div>
...
<script>
import { issueDetail } from "../../api/issue";
export default {
    data() {
        return {
            detailData: {},
